...
#include "stanExports_multi_lik_v2.h"

RCPP_MODULE(stan_fit4multi_lik_v2_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_multi_lik_v2")
