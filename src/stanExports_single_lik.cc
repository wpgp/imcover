...
#include "stanExports_single_lik.h"

RCPP_MODULE(stan_fit4single_lik_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_single_lik")
