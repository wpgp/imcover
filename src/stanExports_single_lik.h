...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(139, 137, "end", "model_single_lik");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            validate_non_negative_index("psi_s", "N_s", N_s);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 27;
        if (!(context__.contains_r("psi_s")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable psi_s missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("psi_s");
        pos__ = 0U;
        validate_non_negative_index("psi_s", "N_s", N_s);
        context__.validate_dims("parameter initialization", "psi_s", "double", context__.to_vec(N_s));
        std::vector<double> psi_s(N_s, double(0));
        size_t psi_s_k_0_max__ = N_s;
        for (size_t k_0__ = 0; k_0__ < psi_s_k_0_max__; ++k_0__) {
            psi_s[k_0__] = vals_r__[pos__++];
        }
        size_t psi_s_i_0_max__ = N_s;
        for (size_t i_0__ = 0; i_0__ < psi_s_i_0_max__; ++i_0__) {
            try {
                writer__.scalar_unconstrain(psi_s[i_0__]);
            } catch (const std::exception& e) {
                stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable psi_s: ") + e.what()), current_statement_begin__, prog_reader__());
            }
        }
        current_statement_begin__ = 28;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 27;
            std::vector<local_scalar_t__> psi_s;
            size_t psi_s_d_0_max__ = N_s;
            psi_s.reserve(psi_s_d_0_max__);
            for (size_t d_0__ = 0; d_0__ < psi_s_d_0_max__; ++d_0__) {
                if (jacobian__)
                    psi_s.push_back(in__.scalar_constrain(lp__));
                else
                    psi_s.push_back(in__.scalar_constrain());
            }
            current_statement_begin__ = 28;
                ...
                for (int jj = 1; jj <= N_j; ++jj) {
                    ...
                    for (int tt = 1; tt <= N_t; ++tt) {
                        ...
                        stan::model::assign(mu, 
                                    ...
                                    (((((((lambda + get_base1(beta_i, ii, "beta_i", 1)) + get_base1(alpha_j, jj, "alpha_j", 1)) + get_base1(phi_t, tt, "phi_t", 1)) + get_base1(get_base1(gamma_it, ii, "gamma_it", 1), tt, "gamma_it", 2)) + get_base1(get_base1(gamma_jt, jj, "gamma_jt", 1), tt, "gamma_jt", 2)) + get_base1(get_base1(gamma_ij, ii, "gamma_ij", 1), jj, "gamma_ij", 2)) + get_base1(get_base1(delta_ijt, ii, "delta_ijt", 1), jj, tt, "delta_ijt", 2)), 
            ...
            lp_accum__.add(normal_log<propto__>(get_base1(psi_s, 1, "psi_s", 1), 0, sigma_s));
            current_statement_begin__ = 72;
            lp_accum__.add(normal_log<propto__>(get_base1(psi_s, 2, "psi_s", 1), 0, sigma_s));
            current_statement_begin__ = 73;
            lp_accum__.add(normal_log<propto__>(get_base1(psi_s, 3, "psi_s", 1), 0, sigma_s3));
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                lp_accum__.add(normal_log<propto__>(get_base1(y, n, "y", 1), (get_base1(psi_s, get_base1(s, n, "s", 1), "psi_s", 1) + get_base1(get_base1(mu, get_base1(i, n, "i", 1), "mu", 1), get_base1(t, n, "t", 1), get_base1(j, n, "j", 1), "mu", 2)), sigma));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
        ...
        try {
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                stan::model::assign(log_lik, 
                            ...
                            normal_log(get_base1(y, n, "y", 1), (get_base1(psi_s, get_base1(s, n, "s", 1), "psi_s", 1) + get_base1(get_base1(mu, get_base1(i, n, "i", 1), "mu", 1), get_base1(t, n, "t", 1), get_base1(j, n, "j", 1), "mu", 2)), sigma), 
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t k_0__ = 0; k_0__ < psi_s_k_0_max__; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "psi_s" << '.' << k_0__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t gamma_it_k_0_max__ = N_i;
        size_t gamma_it_k_1_max__ = N_t;
