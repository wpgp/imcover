...
The `imcover` package is not yet on CRAN and can be installed from Github using
...
This work was funded by WHO and carried out by members of the WorldPop project
at the University of Southampton, United Kingdom. The authors gratefully
acknowledge the WHO-UNICEF immunization coverage working group for their
valuable inputs and feedback during model and software development.
